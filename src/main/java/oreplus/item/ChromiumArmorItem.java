...
public abstract class ChromiumArmorItem extends ArmorItem {
	public ChromiumArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends ChromiumArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "ore_plus:textures/models/armor/chromium_layer_1.png";
		}
	}
	...
	public static class Leggings extends ChromiumArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "ore_plus:textures/models/armor/chromium_layer_2.png";
		}
	}
